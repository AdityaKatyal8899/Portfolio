...
export function AnimatedThemeToggler({
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      setInternalIsDark(document.documentElement.classList.contains("theme-dark"));
    };
  ...
  // Bind custom window event listener so T key in KeyboardNav can trigger this transition
  useEffect(() => {
    const handleToggleEvent = () => {
      toggleTheme();
    };

    window.addEventListener("toggleTheme", handleToggleEvent);
    return () => window.removeEventListener("toggleTheme", handleToggleEvent);
  }, [toggleTheme]);
