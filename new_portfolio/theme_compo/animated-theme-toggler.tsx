...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      ref={buttonRef}
      onClick={toggleTheme}
      className={`relative inline-flex items-center justify-center overflow-hidden transition-all duration-300 active:scale-90 hover:scale-105 ${className || ""}`}
      {...props}
    >
      <div className="relative w-[55%] h-[55%] flex items-center justify-center">
        <Sun
          className={`absolute h-full w-full stroke-[1.5] transition-all duration-500 [transition-timing-function:cubic-bezier(0.34,1.56,0.64,1)] ${
            isDark
